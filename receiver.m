...
[a2,a33,a44,a55]=jianbo(bp2000,bp1000,lpf,DOWN,pyr666);
...
reresult='/';
for i=1:20
reresult=[reresult num2str(a(i)) '/'];
end
%----------------------------------------------------------------------返回
bbbb1 = yima(reresult);      %-----------------译码，并加巴克码     
...
function [F] = yima(LCD_str)
        ...
        %增加前面的保护码，同步吗巴克码
        F=[ones(400,1);[1 1 1 1 1 0 0 1 1 0 1 0 1]';b2;zeros(11,1);[1 1 1 1 1 0 0 1 1 0 1 0 1]';];
  end 
